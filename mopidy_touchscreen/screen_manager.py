...
class ScreenManager():
    ...
    def init_manager(self, size):
        ...
        #Comment-Out Buttons unneeded for player
        #change num_buttons_shown to current number of buttons
        num_buttons_shown = 4
        button_size = (self.size[0] / num_buttons_shown, self.base_size)
        ...
        #set variable x - due to outcomment buttons
        x = 0
